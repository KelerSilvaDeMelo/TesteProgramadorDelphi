...
const RequisitoDesafio1 =
  ...
  'Implemente um algoritmo que receba um array de números inteiros e retorne:'#10#13+
  '1. O segundo maior número da lista.'#10#13+
  '2. A soma de todos os números pares.';
